...
parser.add_argument('--mqtt-host', default="nux.iot.arpas", help="host to connect to the MQTT broker")
parser.add_argument('--mqtt-port', default="18834", type=auto_int, help="port of the MQTT broker")
parser.add_argument('--serial-host', default="192.168.1.211", help="host to connect the serial interface endpoint (i.e. socat /dev/ttyUSB0,parenb,raw,echo=0,b9600,nonblock,min=0 tcp-listen:7001,reuseaddr,fork )")
...
def nasa_update(msgnum, intval):
    try:
        ...
        if nasa_name not in nasa_state:
            pub = True
        else:
...
class MQTTHandler:
    ...
    def publish(self, value_int):
        self.mqtt_client.publish(self.topic, value_int)
...
class FSVWrite2Div10MQTTHandler(FSVWriteMQTTHandler):
    def publish(self, value_int):
        self.mqtt_client.publish(self.topic, value_int / 10.0)
...
class IntDiv100MQTTHandler(MQTTHandler):
    def publish(self, value_int):
        self.mqtt_client.publish(self.topic, value_int / 100.0)
...
class COPMQTTHandler(MQTTHandler):
    def publish(self, value_int):
        ...
        try:
            if value_int == 0:
                value_int = 14
            self.mqtt_client.publish(self.topic + "_cop", int(nasa_state[nasa_message_name(0x4426)] * 100 / value_int) / 100)
        except:
            pass
...
#     mqtt_create_topic(0x40C4, 'homeassistant/number/samsung_ehs_inv_pump_pwm/config', 'power_factor', 'Samsung EHS Inverter Pump PWM', 'homeassistant/number/samsung_ehs_inv_pump_pwm/state', '%', FSVLockUint8MQTTHandler, 'homeassistant/number/samsung_ehs_inv_pump_pwm/set', {
...
#
#     mqtt_create_topic(0x4235, 'homeassistant/number/samsung_ehs_temp_dhw_target/config', 'temperature', 'Samsung EHS Temp DHW Target', 'homeassistant/number/samsung_ehs_temp_dhw_target/state', '°C', IntDiv10MQTTHandler, 'homeassistant/number/samsung_ehs_temp_dhw_target/set', {
#         "min": 35, "max": 70, "step": 1})
...
#     mqtt_client.publish('homeassistant/sensor/samsung_ehs_mqtt_bridge/config', payload=json.dumps({'state_topic': topic_state,
#                                                                                                    'name': 'Samsung EHS Bridge restart date'}), retain=True)
...
#
#     # FSV values
#     mqtt_create_topic(0x4127, 'homeassistant/number/samsung_ehs_2093_tempctrl/config', None, 'Samsung EHS FSV2093 Temp Control', 'homeassistant/number/samsung_ehs_2093_tempctrl/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_2093_tempctrl/set', {
#         "min": 1, "max": 4, "step": 1})
#     mqtt_create_topic(0x40C2, 'homeassistant/number/samsung_ehs_4051_inv_pump_ctrl/config', None, 'Samsung EHS FSV4051 Inverter Pump Control', 'homeassistant/number/samsung_ehs_4051_inv_pump_ctrl/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_4051_inv_pump_ctrl/set', {
#         "min": 0, "max": 2, "step": 1})
#     mqtt_create_topic(0x428A, 'homeassistant/number/samsung_ehs_4052_dt_target/config', 'temperature', 'Samsung EHS FSV4052 dT Target', 'homeassistant/number/samsung_ehs_4052_dt_target/state', '°C', FSVWrite2MQTTHandler, 'homeassistant/number/samsung_ehs_4052_dt_target/set', {
#         "min": 2, "max": 8, "step": 1})
#     mqtt_create_topic(0x40C3, 'homeassistant/number/samsung_ehs_4053_inv_pump_factor/config', None, 'Samsung EHS FSV4053 Inverter Pump Factor', 'homeassistant/number/samsung_ehs_4053_inv_pump_factor/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_4053_inv_pump_factor/set', {
#         "min": 1, "max": 3, "step": 1})
#     # DHW
#     mqtt_create_topic(0x4097, 'homeassistant/number/samsung_ehs_3011_dhw_ctrl/config', None, 'Samsung EHS FSV3011 DHW Control', 'homeassistant/number/samsung_ehs_3011_dhw_ctrl/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_3011_dhw_ctrl/set', {
#         "min": 0, "max": 2, "step": 1})
#     mqtt_create_topic(0x4260, 'homeassistant/number/samsung_ehs_3021_dhw_max_temp/config', None, 'Samsung EHS FSV3021 DHW Max Temp', 'homeassistant/number/samsung_ehs_3021_dhw_max_temp/state', None, FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_3021_dhw_max_temp/set', {
#         "min": 0, "max": 70, "step": 1})
#     mqtt_create_topic(0x4261, 'homeassistant/number/samsung_ehs_3022_dhw_stop_temp/config', None, 'Samsung EHS FSV3022 DHW Stop Temp', 'homeassistant/number/samsung_ehs_3022_dhw_stop_temp/state', None, FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_3022_dhw_stop_temp/set', {
#         "min": 0, "max": 10, "step": 1})
#     mqtt_create_topic(0x4262, 'homeassistant/number/samsung_ehs_3023_dhw_start_temp/config', None, 'Samsung EHS FSV3023 DHW Start Temp', 'homeassistant/number/samsung_ehs_3023_dhw_start_temp/state', None, FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_3023_dhw_start_temp/set', {
#         "min": 0, "max": 30, "step": 1})
#     mqtt_create_topic(0x4263, 'homeassistant/number/samsung_ehs_3024_dhw_sh_min_sh_time/config', None, 'Samsung EHS FSV3024 DHW+SH Min Heating Duration', 'homeassistant/number/samsung_ehs_3024_dhw_sh_min_time/state', None, FSVWrite2MQTTHandler, 'homeassistant/number/samsung_ehs_3024_dhw_sh_min_time/set', {
#         "min": 1, "max": 20, "step": 1})
#     mqtt_create_topic(0x4264, 'homeassistant/number/samsung_ehs_3025_dhw_sh_max_dhw_time/config', None, 'Samsung EHS FSV3025 DHW+SH Max DHW Duration', 'homeassistant/number/samsung_ehs_3025_dhw_sh_max_dhw_time/state', None, FSVWrite2MQTTHandler, 'homeassistant/number/samsung_ehs_3025_dhw_sh_max_dhw_time/set', {
#         "min": 5, "max": 95, "step": 5})
#     mqtt_create_topic(0x4265, 'homeassistant/number/samsung_ehs_3026_dhw_sh_max_sh_time/config', None, 'Samsung EHS FSV3026 DHW+SH Max Heating Duration', 'homeassistant/number/samsung_ehs_3026_dhw_sh_max_sh_time/state', None, FSVWrite2MQTTHandler, 'homeassistant/number/samsung_ehs_3026_dhw_sh_max_sh_time/set', {
#         "min": 30, "max": 600, "step": 30})
#     mqtt_create_topic(0x4098, 'homeassistant/number/samsung_ehs_3031_dhw_booster_ctrl/config', None, 'Samsung EHS FSV3031 DHW Booster Control', 'homeassistant/number/samsung_ehs_3031_dhw_booster_ctrl/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_3031_dhw_booster_ctrl/set', {
#         "min": 0, "max": 2, "step": 1})
#     mqtt_create_topic(0x4099, 'homeassistant/number/samsung_ehs_3041_dhw_disinfect/config', None, 'Samsung EHS FSV3041 DHW Disinfection', 'homeassistant/number/samsung_ehs_3041_dhw_disinfect/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_3041_dhw_disinfect/set', {
#         "min": 0, "max": 1, "step": 1})
#     mqtt_create_topic(0x409B, 'homeassistant/number/samsung_ehs_3051_dhw_forced_timer_off/config', None, 'Samsung EHS FSV3051 DHW Forced Timer OFF', 'homeassistant/number/samsung_ehs_3051_dhw_forced_timer_off/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_3051_dhw_forced_timer_off/set', {
#         "min": 0, "max": 1, "step": 1})
...
#         "min": 0, "max": 30, "step": 1})
#     mqtt_create_topic(0x4093, 'homeassistant/number/samsung_ehs_2041_wl/config', None, 'Samsung EHS FSV2041 Water Law', 'homeassistant/number/samsung_ehs_2041_wl/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_2041_wl/set', {
#         "min": 1, "max": 2, "step": 1})
#     # heating
#     mqtt_create_topic(0x4254, 'homeassistant/number/samsung_ehs_2011_wlmax/config', 'temperature', 'Samsung EHS FSV2011 Heating Water Law Max', 'homeassistant/number/samsung_ehs_2011_wlmax/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2011_wlmax/set', {
#         "min": -20, "max": 5, "step": 1})
#     mqtt_create_topic(0x4255, 'homeassistant/number/samsung_ehs_2012_wlmin/config', 'temperature', 'Samsung EHS FSV2012 Heating Water Law Min', 'homeassistant/number/samsung_ehs_2012_wlmin/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2012_wlmin/set', {
#         "min": 10, "max": 20, "step": 1})
#     mqtt_create_topic(0x4256, 'homeassistant/number/samsung_ehs_2021_wl1max/config', 'temperature', 'Samsung EHS FSV2021 Heating Water Out WL1 Temp Max', 'homeassistant/number/samsung_ehs_2021_wl1max/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2021_wl1max/set', {
#         "min": 17, "max": 75, "step": 1})
#     mqtt_create_topic(0x4257, 'homeassistant/number/samsung_ehs_2022_wl1min/config', 'temperature', 'Samsung EHS FSV2022 Heating Water Out WL1 Temp Min', 'homeassistant/number/samsung_ehs_2022_wl1min/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2022_wl1min/set', {
#         "min": 17, "max": 75, "step": 1})
#     mqtt_create_topic(0x4258, 'homeassistant/number/samsung_ehs_2031_wl2max/config', 'temperature', 'Samsung EHS FSV2031 Heating Water Out WL2 Temp Max', 'homeassistant/number/samsung_ehs_2031_wl2max/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2031_wl2max/set', {
#         "min": 17, "max": 75, "step": 1})
#     mqtt_create_topic(0x4259, 'homeassistant/number/samsung_ehs_2032_wl2min/config', 'temperature', 'Samsung EHS FSV2032 Heating Water Out WL2 Temp Min', 'homeassistant/number/samsung_ehs_2032_wl2min/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2032_wl2min/set', {
#         "min": 17, "max": 75, "step": 1})
#     # cooling
#     mqtt_create_topic(0x425A, 'homeassistant/number/samsung_ehs_2051_wlmax/config', 'temperature', 'Samsung EHS FSV2051 Cooling Water Law Max', 'homeassistant/number/samsung_ehs_2051_wlmax/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2051_wlmax/set', {
#         "min": 25, "max": 35, "step": 1})
#     mqtt_create_topic(0x425B, 'homeassistant/number/samsung_ehs_2052_wlmin/config', 'temperature', 'Samsung EHS FSV2052 Cooling Water Law Min', 'homeassistant/number/samsung_ehs_2052_wlmin/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2052_wlmin/set', {
#         "min": 35, "max": 45, "step": 1})
#     mqtt_create_topic(0x425C, 'homeassistant/number/samsung_ehs_2061_wl1max/config', 'temperature', 'Samsung EHS FSV2061 Cooling Water Out WL1 Temp Max', 'homeassistant/number/samsung_ehs_2061_wl1max/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2061_wl1max/set', {
#         "min": 5, "max": 25, "step": 1})
#     mqtt_create_topic(0x425D, 'homeassistant/number/samsung_ehs_2062_wl1min/config', 'temperature', 'Samsung EHS FSV2062 Cooling Water Out WL1 Temp Min', 'homeassistant/number/samsung_ehs_2062_wl1min/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2062_wl1min/set', {
#         "min": 5, "max": 25, "step": 1})
#     mqtt_create_topic(0x425E, 'homeassistant/number/samsung_ehs_2071_wl2max/config', 'temperature', 'Samsung EHS FSV2071 Cooling Water Out WL2 Temp Max', 'homeassistant/number/samsung_ehs_2071_wl2max/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2071_wl2max/set', {
#         "min": 5, "max": 25, "step": 1})
#     mqtt_create_topic(0x425F, 'homeassistant/number/samsung_ehs_2072_wl2min/config', 'temperature', 'Samsung EHS FSV2072 Cooling Water Out WL2 Temp Min', 'homeassistant/number/samsung_ehs_2072_wl2min/state', '°C', FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_2072_wl2min/set', {
#         "min": 5, "max": 25, "step": 1})
#
#     # mixing valve settings
#     mqtt_create_topic(0x40C0, 'homeassistant/number/samsung_ehs_4041_V3V_enabled/config', None, 'Samsung EHS FSV4041 Mixing Valve Enabled', 'homeassistant/number/samsung_ehs_4041_V3V_enabled/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_4041_V3V_enabled/set', {
#         "min": 0, "max": 2, "step": 1})
#     mqtt_create_topic(0x4286, 'homeassistant/number/samsung_ehs_4042_V3V_dt/config', None, 'Samsung EHS FSV4042 Mixing Valve dT Heating', 'homeassistant/number/samsung_ehs_4042_V3V_dt/state', None, FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_4042_V3V_dt/set', {
#         "min": 5, "max": 15, "step": 1})
#     mqtt_create_topic(0x4287, 'homeassistant/number/samsung_ehs_4043_V3V_dt/config', None, 'Samsung EHS FSV4043 Mixing Valve dT Cooling', 'homeassistant/number/samsung_ehs_4043_V3V_dt/state', None, FSVWrite2Div10MQTTHandler, 'homeassistant/number/samsung_ehs_4043_V3V_dt/set', {
#         "min": 5, "max": 15, "step": 1})
#     mqtt_create_topic(0x40C1, 'homeassistant/number/samsung_ehs_4044_V3V_factor/config', None, 'Samsung EHS FSV4044 Mixing Valve Factor', 'homeassistant/number/samsung_ehs_4044_V3V_factor/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_4044_V3V_factor/set', {
#         "min": 1, "max": 5, "step": 1})
#     mqtt_create_topic(0x4288, 'homeassistant/number/samsung_ehs_4045_V3V_interval/config', None, 'Samsung EHS FSV4045 Mixing Valve Interval (minute)', 'homeassistant/number/samsung_ehs_4045_V3V_interval/state', None, FSVWrite2MQTTHandler, 'homeassistant/number/samsung_ehs_4045_V3V_interval/set', {
#         "min": 1, "max": 30, "step": 1})
#     mqtt_create_topic(0x4289, 'homeassistant/number/samsung_ehs_4046_V3V_runtime/config', None, 'Samsung EHS FSV4046 Mixing Valve Running Time (x10 seconds)', 'homeassistant/number/samsung_ehs_4046_V3V_runtime/state', None, FSVWrite2MQTTHandler, 'homeassistant/number/samsung_ehs_4046_V3V_runtime/set', {
#         "min": 6, "max": 24, "step": 3})
#     mqtt_create_topic(0x411a, 'homeassistant/number/samsung_ehs_zone_control/config', None, 'Samsung EHS FSV4061 Zone Control', 'homeassistant/number/samsung_ehs_zone_control/state', None, FSVWrite1MQTTHandler, 'homeassistant/number/samsung_ehs_zone_control/set', {
#         "min": 0, "max": 2, "step": 1})
